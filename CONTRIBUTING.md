# Information and Guidelines for Contributing to pointblank

There are many ways to contribute to the ongoing development of the
**pointblank** package. Some contributions can be rather easy to do
...
[**pointblank** issue
tracker](https://github.com/rstudio/pointblank/issues). Try not to
...
**pointblank** include [Posit community](https://forum.posit.co),
Bluesky (a good search term is `pointblank #rstats`), and [Stack
...
- Look at the GitHub Actions build status badges before and after making
  ...
  [README](https://github.com/rstudio/pointblank).  
- The **pointblank** package follows the tidyverse [style
