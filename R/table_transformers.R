...
#' [tt_summary_stats()], [tt_string_info()], or [tt_tbl_dims()]. The following
#' parameter keywords are to be used depending on the input `tbl`:
#'
...
#'   [tt_string_info()], or [tt_tbl_dims()] functions.
...
#'   of a summary table obtained by [tt_summary_stats()], [tt_string_info()], or
#'   [tt_tbl_dims()].
...
#'   [tt_summary_stats()] and [tt_string_info()] (the [tt_tbl_dims()] function
#'   will always generate a two-column summary table).
#'   
#' @examples 
#' # Get summary statistics for the
