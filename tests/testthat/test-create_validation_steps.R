...
test_that("Creating a `col_is_character()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_is_character(column = everything())
...
test_that("Creating a `col_is_factor()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_is_factor(column = everything())
...
test_that("Creating a `col_is_integer()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_is_integer(column = everything())
...
test_that("Creating a `col_is_logical()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_is_logical(column = everything())
...
test_that("Creating a `col_is_numeric()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_is_numeric(column = everything())
...
test_that("Creating a `col_is_posix()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_is_posix(column = everything())
...
test_that("Creating a `col_vals_between()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_between(column = everything(), left = 2, right = 10)
...
test_that("Creating a `col_vals_not_between()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_not_between(column = everything(), left = 2, right = 10)
...
test_that("Creating a `col_vals_equal()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_equal(column = everything(), value = 5)
...
test_that("Creating a `col_vals_not_equal()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_not_equal(column = everything(), value = 5)
...
test_that("Creating a `col_vals_gt()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_gt(column = everything(), value = 5)
...
test_that("Creating a `col_vals_gte()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_gte(column = everything(), value = 5)
...
test_that("Creating a `col_vals_lt()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_lt(column = everything(), value = 5)
...
test_that("Creating a `col_vals_lte()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_lte(column = everything(), value = 5)
...
test_that("Creating a `col_vals_in_set()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_in_set(column = everything(), set = c("1-bcd-345", "5-jdo-903"))
...
test_that("Creating a `col_vals_not_in_set()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_not_in_set(column = everything(), set = c("1-bcd-345", "5-jdo-903"))
...
test_that("Creating a `col_vals_regex()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_regex(column = everything(), regex = "[0-9]-.*")
...
test_that("Creating a `col_vals_null()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_null(column = everything())
...
test_that("Creating a `col_vals_not_null()` step is possible", {
  ...
  validation_all <-
    create_agent(tbl = small_table) %>%
    col_vals_not_null(column = everything())
