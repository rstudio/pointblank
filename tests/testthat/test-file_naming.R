...
test_that("affixing a datetime to a filename works well", {
  ...
  expect_match(
    ...
    "the_file--20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}((+|-)[0-9]{4}|Z).txt"
  )
  expect_match(
    affix_datetime(
  ...
  expect_match(
    ...
    "the_file--20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}((+|-)[0-9]{4}|Z)"
  )
  expect_match(
    affix_datetime(
  ...
  expect_match(
    ...
    "20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}((+|-)[0-9]{4}|Z)--the_file"
  )
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "end", format = "%Y-%m-%dT%H:%M:%S",
  ...
  expect_match(
    ...
    "the_file--20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}.txt"
  )
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "end",
  ...
  expect_match(
    ...
    "20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}--the_file.txt"
  )
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "start",
  ...
  expect_match(
    ...
    "the_file--20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}"
  )
  expect_match(
    affix_datetime(
      filename = file_name, position = "end",
  ...
  expect_match(
    ...
    "20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}--the_file"
  )
  expect_match(
    affix_datetime(
      filename = file_name, position = "start",
