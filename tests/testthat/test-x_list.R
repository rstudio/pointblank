...
test_that("An x-list for a step is structurally correct", {
  ...
  expect_type(x_list_before$stop, "logical")
  expect_equal(x_list_before$stop, NA)
  expect_type(x_list_before$notify, "logical")
  ...
  expect_type(x_list_after$stop, "logical")
  expect_equal(x_list_after$stop, TRUE)
  expect_type(x_list_after$notify, "logical")
...
test_that("A complete x-list is structurally correct", {
  ...
  expect_equal(ncol(x_list_before$validation_set), 36)
  expect_type(x_list_before$lang, "character")
  expect_equal(x_list_before$lang, "en")
  ...
  expect_equal(ncol(x_list_after$validation_set), 36)
  expect_type(x_list_after$lang, "character")
  expect_equal(x_list_after$lang, "en")
