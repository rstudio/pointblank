...
#' \if{html}{
#' \out{
#' `r pb_get_image_tag(file = "man_col_vals_equal_1.png")`
#' }
#' }
#' 
...
#' 
#' ```r
#' expect_col_vals_equal(tbl, vars(a), value = 5)
#' ```
#' 
...
#' 
#' ```{r}
#' test_col_vals_equal(tbl, vars(a), value = 5)
#' ```
#' 
...
#' @import rlang
#' @export
expect_col_vals_equal <- function(
    object,
    columns,
    value,
    na_pass = FALSE,
