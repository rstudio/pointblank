...
#' 
#' We can get a table metadata report from a metadata object, generated by the
#' [create_metadata()] function. The report is provided as a **gt** based
