...
#' 
#' The `col_vals_not_equal()` validation step function and the
#' `expect_col_vals_not_equal()` expectation function both check whether column
#' values in a table *are not* equal to a specified `value`. The validation step
