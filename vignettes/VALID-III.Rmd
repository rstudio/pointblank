...
- `expect_col_vals_le()`: Expect that column data are less than or equal to a specified value.
...
- `expect_col_vals_ge()`: Expect that column data are greater than or equal to a specified value.
