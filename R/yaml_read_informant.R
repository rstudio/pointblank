...
#'
#' With `meta_yaml_read()` we can read a **pointblank** YAML file that describes
#' table information (typically generated by the [yaml_write()] function. What's
#' returned is a new *informant* object with the information intact. The
#' *informant* object can be given more information through use of the
#' `info_*()` functions.
#' 
