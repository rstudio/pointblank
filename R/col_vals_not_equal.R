...
#'   compatible column given in `vars()`. Any column values not equal to what is
...
#' \if{html}{
#' \out{
#' `r pb_get_image_tag(file = "man_col_vals_not_equal_1.png")`
#' }
#' }
#' 
...
#' @import rlang
#' @export
expect_col_vals_not_equal <- function(
    object,
    columns,
    value,
    na_pass = FALSE,
...
#' @import rlang
#' @export
test_col_vals_not_equal <- function(
    object,
    columns,
    value,
    na_pass = FALSE,
