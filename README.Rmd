...
- great flexibility in workflows, allowing for: (1) report-based validations, (2) inline validations, (3) validation of data in unit tests (with the set of `expect_*()` functions), and (4) validation of data to support conditional expressions (with the set of `test_*()` functions) 
