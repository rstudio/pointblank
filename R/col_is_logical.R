...
#'
#' The `col_is_logical()` validation step function and the
#' `expect_col_is_logical()` expectation function both check whether one or more
#' columns in a table is of the logical (`TRUE`/`FALSE`) type. Like many of the
...
#' whether the column is an logical-type column or not.
#' 
