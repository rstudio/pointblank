...
Really, the sky is the limit here! We can incorporate a great deal of useful information here and use this process to generate reports on all of the important tables within an organization. But there's more that can be done. To do that you have to go on to the the next phase (the [*Advanced Information Management*](../articles/INFO-2.html) article). You'll have to go all the way now, total transformation. Do you think you're ready? The aforelinked article will show you how.
