...
#' (this is defined within the \code{interrogate()} call).
...
#'   produced sample row data, one can use the \code{get_row_sample_info()}
#'   function. The data frame output provides the step number and the number of
#'   rows in the sample.
#' @examples 
#' # Set a seed
#' set.seed(23)
