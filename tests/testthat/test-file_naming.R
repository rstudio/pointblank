...
test_that("affixing a datetime to a filename works well", {
  ...
  expect_match(
    ...
    "the_file_20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}-[0-9]{4}.txt"
  )  
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "end", format = "%Y-%m-%d",
    ...
    "the_file_20[0-9]{2}-[0-9]{2}-[0-9]{2}-[0-9]{4}.txt"
  )
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "end", format = "%m-%d",
    ...
    "the_file_[0-9]{2}-[0-9]{2}-[0-9]{4}.txt"
  )
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "end", format = "%m-%d-%Y",
    ...
    "the_file_[0-9]{2}-[0-9]{2}-20[0-9]{2}-[0-9]{4}.txt"
  )
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "end", delimiter = "--", utc_time = TRUE
    ),
    "the_file--20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z.txt"
  )
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "end", delimiter = "--", utc_time = FALSE
    ),
    "the_file--20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}-[0-9]{4}.txt"
  )
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "start", delimiter = "--", utc_time = TRUE
    ),
    "20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z--the_file.txt"
  )
  expect_match(
    affix_datetime(
      filename = file_name_ext, position = "start", delimiter = "--", utc_time = FALSE
    ),
    "20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}-[0-9]{4}--the_file.txt"
  )
  expect_match(
    affix_datetime(
      filename = file_name, position = "end", delimiter = "--", utc_time = TRUE
    ),
    "the_file--20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z"
  )
  expect_match(
    affix_datetime(
      filename = file_name, position = "end", delimiter = "--", utc_time = FALSE
    ),
    "the_file--20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}-[0-9]{4}"
  )
  expect_match(
    affix_datetime(
      filename = file_name, position = "start", delimiter = "--", utc_time = TRUE
    ),
    "20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z--the_file"
  )
  expect_match(
    affix_datetime(
      filename = file_name, position = "start", delimiter = "--", utc_time = FALSE
    ),
    "20[0-9]{2}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}-[0-9]{4}--the_file"
  )
})
