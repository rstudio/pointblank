...
Here's another example that follows the second, *agent*-less workflow (validation step functions operating directly on data).

```{r example_workflow_two, paged.print=FALSE}
